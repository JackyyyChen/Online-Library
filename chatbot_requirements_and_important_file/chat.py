...
# 设置 max_split_size_mb 为 64
# torch.cuda.set_memory_growth(True)
# torch.cuda.max_memory_allocated(32*1024*1024)
# torch.cuda.max_memory_cached(32*1024*1024)
...
if CHAT_LANG == 'English':
    # args.MODEL_NAME = 'E:\ChatRWKV\RWKV-4-Pile-3B-EngChn-testNovel-done-ctx2048-20230226'
    args.MODEL_NAME = 'E:\capstone_project_9900f16awesley\ChatRWKV\RWKV-4-Pile-1B5-EngChn-testNovel-done-ctx2048-20230225.pth'
