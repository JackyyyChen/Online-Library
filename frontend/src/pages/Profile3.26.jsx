...
//   // };
//
//   // const oldname = localStorage.getItem('user');
//   // console.log(oldname);
//
//   const handleSubmit = async (event) => {
//     event.preventDefault();
//     // 在这里处理表单提交逻辑
//     console.log('提交表单:', { username, email});
...
//             Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis at orci risus. Aenean tristique magna et semper ultrices.
//           </Typography>
...
//                 {/*<TextField label="Bio" value={bio} type="bio" onChange={handleBioChange} fullWidth />*/}
...
//   ===================制作弹窗，更改用户信息=======================
  ...
  const handleClose = () => {
   ...
   const handleUpgrade = async () => {
     ...
     const response = await fetchFunc('/user_upgrade/', 'POST', userInfo)
